...
```javascript
const frame = new Frame("zim", 800, 600, "lightblue", ready);
...
function ready() {
  ...
  new Pic("cat.jpg").center().sca(0.5); // O facem 50% din marimea originala
...
_Proiect album foto:_

```js
// Aici vom scrie codul nostru ZIM
const frame = new Frame("zim", 1000, 600, "#333", "#555", ready);
